      ...
      <main className="bg-white dark:bg-slate-950 text-gray-900 dark:text-gray-100">
        <section className="relative overflow-hidden bg-[url('/images/community-performance.svg')] bg-cover bg-center py-24">
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center text-white">
            <span className="inline-flex items-center rounded-full bg-purple-600/30 px-4 py-2 text-sm font-semibold uppercase tracking-wide mb-4">
              Our Programs
            </span>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid gap-8">
              {PROGRAMS.map((program) => {
                ...
                return (
                  <div key={program.id} className="grid gap-6 lg:grid-cols-[1fr_2fr] bg-white dark:bg-slate-900 rounded-3xl shadow-sm border border-gray-200 dark:border-gray-800 overflow-hidden">
                    <div className="p-8 bg-purple-600/5 dark:bg-purple-500/10">
        ...
        <section className="py-16 bg-purple-600 text-white">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
            <span className="inline-flex rounded-full bg-white/20 px-3 py-1 text-sm uppercase tracking-wide mb-4">Coming Soon</span>
            <h2 className="text-3xl font-bold">The Circus Centre</h2>
            <p className="mt-4 text-lg text-purple-100 max-w-3xl mx-auto">
              Our long-term vision is to establish a permanent Circus Center in Uganda where young people can train, perform, and thrive in a safe creative community.
            </p>
            <Link
              href="/contact"
              className="mt-8 inline-flex items-center px-6 py-3 bg-white text-purple-700 font-semibold rounded-lg hover:bg-gray-100 transition"
            >
              Join the Movement
