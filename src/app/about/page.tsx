        ...
        <section className="relative overflow-hidden bg-slate-900 text-white py-24">
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl">
              <span className="inline-flex items-center rounded-full bg-sky-100/20 px-4 py-2 text-sm font-semibold text-sky-200 mb-4">
                Who We Are
              </span>
              <h1 className="text-4xl sm:text-5xl font-bold tracking-tight">Who We Are</h1>
              <p className="mt-6 text-lg text-sky-100/90 leading-8">
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid gap-10 lg:grid-cols-2 lg:items-start">
              <div className="space-y-8">
                <div className="rounded-3xl bg-sky-700/5 dark:bg-white/5 p-8 shadow-sm border border-gray-200/70 dark:border-slate-800">
                ...
                <div className="grid gap-6 sm:grid-cols-3">
                  <div className="rounded-3xl bg-sky-600/10 dark:bg-sky-500/10 p-6">
            ...
            <div className="mt-16 rounded-3xl bg-gradient-to-r from-sky-600 to-sky-900 text-white p-10 shadow-xl">
              <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-6">
                <div>
                  ...
                  <p className="mt-4 max-w-2xl text-sky-100/90 leading-7">
